...
# Then, (24*60*2 = 2880) and we are at 2/2/2007 23:59:00
 ...
 with(house, {
 plot(house$Date, house$V3, pch = "|", xlab ="", ylab = "Global Active Power (kilowatts)")
 plot(house$Date, house$V5, pch = "|", xlab ="datetime", ylab = "Voltage")
 plot(house$Date, house$V7, type = "n", xlab = "", ylab = "Energy sub metering") 
 points(house$Date, y = house$V7, pch = "|")
 points(house$Date, y = house$V8, col = "red", pch = "|")
 points(house$Date, y = house$V9, col = "blue", pch = "|")
 legend("topright", pch = "|", col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
 plot(house$Date, house$V4, pch = "|", xlab ="datetime", ylab = "Global_reactive_power")
 })
