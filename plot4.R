...
# Then, (24*60*2 = 2880) and we are at 2/2/2007 23:59:00
 ...
 with(house, {
 plot(house$Date, house$V3, pch = "|", xlab ="", ylab = "Global Active Power (kilowatts)", type = "l")
 plot(house$Date, house$V5, pch = "|", xlab ="datetime", ylab = "Voltage", type = "l")
 ...
 plot(house$Date, house$V4, pch = "|", xlab ="datetime", ylab = "Global_reactive_power", type = "l")
 })
